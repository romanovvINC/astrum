...
namespace Astrum.Appeal.Migrations
{
    ...
    [Migration("20221226055819_JoinTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppealAppealCategory", b =>
                {
                    b.Property<Guid>("AppealsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CategoriesId")
                        .HasColumnType("uuid");

                    b.HasKey("AppealsId", "CategoriesId");
            ...
            modelBuilder.Entity("AppealAppealCategory", b =>
                {
                    b.HasOne("Astrum.Appeal.Aggregates.Appeal", null)
                        .WithMany()
                        .HasForeignKey("AppealsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Astrum.Appeal.Aggregates.AppealCategory", null)
                        .WithMany()
