...
namespace Astrum.Articles.Persistence.Migrations
{
    ...
    [Migration("20230505110247_AddNullableToContent")]
    partial class AddNullableToContent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Astrum.Articles.Aggregates.Article", b =>
                {
                    ...
                    b.Property<string>("TrackerArticleId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Astrum.Articles.Aggregates.ArticleTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Astrum.Articles.Aggregates.ArticleTag", b =>
                {
                    ...
                    b.HasOne("Astrum.Articles.Aggregates.Tag", null)
            ...
            modelBuilder.Entity("Astrum.Articles.Aggregates.Tag", b =>
                {
                    b.HasOne("Astrum.Articles.Aggregates.Category", null)
                        .WithMany("Tags")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
