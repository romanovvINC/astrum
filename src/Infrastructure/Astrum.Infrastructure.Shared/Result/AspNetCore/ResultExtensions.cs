...
public static class ResultExtensions
{
    ...
    /// <param name="result">The Result to convert to an ActionResult</param>
    /// <returns></returns>
    public static ActionResult ToActionResult(this SharedLib.Common.Results.Result result, ControllerBase controller)
    {
        return controller.ToActionResult((IResult)result);
    }
    ...
    static internal ActionResult ToActionResult(this ControllerBase controller, IResult result)
    {
        switch (result.Status)
        {
            case ResultStatus.Ok:
                return result is SharedLib.Common.Results.Result
                    ? controller.Ok()
