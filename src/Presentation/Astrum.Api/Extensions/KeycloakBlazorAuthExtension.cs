...
{
    public static class KeycloakBlazorAuthExtension
    {
                ...
                .AddOpenIdConnect(options =>
                {
                    ...
                    options.Events = new OpenIdConnectEvents
                    {
                        OnTokenValidated = t =>
                        {
                            ...
                            var identity = ((ClaimsIdentity)t.Principal.Identity);
                            
                            identity.SetIdentityClaims(t.TokenEndpointResponse.AccessToken,
                            ...
                            // ClaimsPrincipal newIdentity = TransformClaims(e.Ticket.Principal);
                            // var newIdentity = new ClaimsIdentity(identity.Claims, OpenIdConnectDefaults.AuthenticationScheme);
                            //
                            // t.HttpContext.SignInAsync(
                            //     OpenIdConnectDefaults.AuthenticationScheme,
                            //     new ClaimsPrincipal(newIdentity)).Wait();
