...
using Astrum.Api.Validators.LocalizedDataAnnotationsValidator.Internals.ValidationAttributeStores;
...
static internal class LocalizedValidator
{
    ...
    private static LocalizedValidationContext CreateValidationContext(object instance,
        LocalizedValidationContext validationContext)
    {
        return new LocalizedValidationContext(validationContext.Localizer,
